This directory contains the HTRC Extracted Features files for 304 volumes of Spanish-language fiction identified by Dr. José Gonzalez as examples of the Modernismo genre, including fiction works that are not novels. There is an separate JSON file for each file. 
