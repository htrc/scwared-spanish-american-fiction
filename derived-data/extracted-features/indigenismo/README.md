This directory contains the HTRC Extracted Features files for 81 volumes of Spanish-language fiction identified by Dr.. José Gonzalez as examples of the Indigenismo genre. There is an separate JSON file for each file. 
