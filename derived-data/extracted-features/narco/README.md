This directory contains the HTRC Extracted Features files for 46 volumes of Spanish-language fiction identified by Dr. José Gonzalez as examples of Narcoliterature. There is an separate JSON file for each file. 
