This directory contains the HTRC Extracted Features files for 78 volumes of Spanish-language fiction identified by Dr. José Gonzalez as examples of the "La Violencia" genre. There is an separate JSON file for each file. 
